	...
	<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/le-frog/jquery-ui.css">
        ...
        <script>
            ...
            function getNameHerader(){
               ...
               $.ajax({
                   url:'<%=request.getContextPath()%>/check_headerID',
            ...
            //RuleOfOrganization
            function change_input_RuleOfOrganization(){
                $('#input_RuleOfOrganization').change(function(){               
                    var x = document.getElementById("input_RuleOfOrganization").checked;
                    if(x){
                        validate_RuleOfOrganization = true;
                    }
                });
            }
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="radio" id="input_ProfileStudy" name="frm_ProfileStudyOrWork">กำลังศึกษา
                            <input type="radio" id="input_ProfileWork" name="frm_ProfileStudyOrWork">ทำงาน
                        </td>
                    </tr>    
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" id="input_InterrestingProducts" name="frm_InterrestingProducts">สนใจผลิตภันฑ์<br/>
                            <input type="radio" id="input_InterrestingIncone" name="frm_InterrestingIncone">สนใจ รายได้<br/>
                            <input type="radio" id="input_InterrestingUsing" name="frm_InterrestingUsing">สนใจซื้อใช้ในราคาถูก<br/>
                            อื่นๆ<input type="text" id="input_InterrestingOther" name="frm_InterrestingOther">
                        </td>
                    </tr>             
                    <tr>
                        ...
                        <td>1. <input type="text" id="input_SaleArea1" name="frm_SaleArea1"><br/>
                            ...
                            4. <input type="text" id="" name="frm_SaleArea4">
                        </td>
                    </tr>                            
                    <tr>
                        <td>ท่านยอมรับเงื่อนไขของทาง<br/>ครอบครัว CHI'DE หรือไม่</td>           
                        <td>
                            <input type="radio" id="input_RuleOfOrganization" name="frm_RuleOfOrganization">ยอมรับ
                            <input type="radio" id="" name="frm_RuleOfOrganization">ไม่ยอมรับ
                        </td>
                    </tr>  
                    <tr>
                        <td>Username</td>                                           
